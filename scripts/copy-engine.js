/**
 * copy-engine.js - Copy Client Engine to Functions
 * 
 ...
 * Or:  node scripts/copy-engine.js (from project root)
 * 
 * @version 3.0.0
 */
...
function copyEngineFiles() {
    console.log('🚀 Copying engine files to functions/src/shared...\n');

    // Create destination directory
    if (!fs.existsSync(destShared)) {
        fs.mkdirSync(destShared, { recursive: true });
        console.log(`📁 Created: ${destShared}`);
    }
    ...
    for (const file of filesToCopy) {
        ...
        tsContent = `/**\n * AUTO-GENERATED - Do not edit directly!\n * Source: src/engine/${file}\n * Generated by: scripts/copy-engine.js\n */\n\n` + tsContent;
        ...
        console.log(`✅ Copied: ${file} → shared/${file.replace('.js', '.ts')}`);
    }
    ...
    for (const constFile of constantsToCopy) {
        ...
        if (fs.existsSync(srcPath)) {
            ...
            constantsContent += '\n\n';
            console.log(`  ✅ Included: ${constFile}`);
        }
    }
